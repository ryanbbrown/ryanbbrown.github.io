...
I especially like capping interviews with an open-ended question that really lets great candidates shine. One of my favorite now-retired questions is, [in Thielian fashion](https://www.safegraph.com/blog/why-the-famous-peter-thiel-interview-question-is-so-predictive): “What’s something you’ve learned that you believe gives you an edge - something that you’re almost surprised more people don’t know about?”
...
#1 and #2 are common structured approaches to learning, whereas #3 is a relatively novel interpretation of [spaced repetition](https://en.wikipedia.org/wiki/Spaced_repetition). But at a more meta level, the unexpected takeaway is the vast majority of people likely haven’t updated their mental model for learning in decades. (Stop and think for a moment on the last time you did this.)
