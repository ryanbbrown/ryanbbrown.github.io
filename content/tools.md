...
- [VSCode](https://code.visualstudio.com/): I used to use Claude Code from within Cursor, but I wasn’t really using Cursor Tab and I like having my AI terminals popped out as a separate window (Cursor’s is buggy when zooming).
- [Claude Code](https://www.claude.com/product/claude-code): I use the Tavily MCP for web search and have a web search subagent so my main context doesn’t get bloated with search results. I usually have 2-3 sessions going in parallel. I’ve experimented with more subagents but haven’t found it particularly beneficial for my use cases; I get more lift from session management. I also gave Codex a solid try based on [this post](https://steipete.me/posts/just-talk-to-it) and liked it better at first, but switched back after frustration with its [incessant use of Python](https://github.com/openai/codex/discussions/3057) to read/write files (instead of native tools). 
